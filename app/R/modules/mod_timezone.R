...
mod_timezone_ui <- function(id){
  ...
  tagList(
    ...
    tags$fieldset(
      tags$legend(id = ns("legend_tz_offset"), textOutput(ns("lbl_tz_offset_policy"))),
      radioButtons(ns("tz_offset_policy"), label = NULL, choices = c("std" = "std", "modal" = "modal"), selected = "std")
    ),
